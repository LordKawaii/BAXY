...
if ceil(steps*(hp/obj_controller.hp_max_G)) >= 1 {
...
draw_set_color(c_white)
    ...
    side=!side
    hps=hp/(ceil(steps*(hp/obj_controller.hp_max_G))+1)
    hpd=0
    repeat ceil(steps*(hp/obj_controller.hp_max_G)+1) {
        step+=1
        
        if step=ceil(steps*(hp/obj_controller.hp_max_G)+1) { //final step
